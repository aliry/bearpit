...
# Matrix localpart of the human operator, unless AGENTREALM_OPERATOR_USER says otherwise.
DEFAULT_OPERATOR = "operator"


class Settings(BaseSettings):
    model_config = SettingsConfigDict(env_prefix="AGENTREALM_", extra="ignore")
    ...
    # set AGENTREALM_DATABASE_URL to match it (see deploy/.env.example). A wrong password here
    # surfaces as a connection error at startup, not as silent data loss.
    database_url: str = "postgresql+asyncpg://arealm:arealm@localhost:5432/agentrealm"
    ...
    matrix_homeserver_internal: str = "http://arealm-conduit:6167"
    matrix_server_name: str = "realm.local"
    conduit_container: str = "arealm-conduit"
    ...
    litellm_url_internal: str = "http://arealm-litellm:4000"
    litellm_container: str = "arealm-litellm"
    ...
    realmtools_url_internal: str = "http://arealm-realmtools:9100/mcp"
    realmtools_container: str = "arealm-realmtools"
    ...
    # control). Set AGENTREALM_OPERATOR_USER to use your own account.
