/* AgentRealm control panel — a small hash-routed SPA over the Gatekeeper REST API.
...
function showTokenGate() {
  ...
  const box = el("div", { class: "panel", style: "max-width:640px;margin:60px auto" },
    ...
    el("span", { class: "kbd", text: "arealm serve" }),
    ...
    el("span", { class: "kbd", text: "~/.agentrealm/api-token" }));
  ...
  const hero = el("section", { class: "landing-hero" },
    el("div", { class: "hero-copy" },
      ...
      el("p", { class: "hero-sub", text:
        "Define a project and a roster of agents. AgentRealm runs them as independent, always-on "
...
route(/^\/settings$/, async () => {
  ...
  wrap.append(el("div", { class: "grid", style: "grid-template-columns:repeat(auto-fit,minmax(230px,1fr));margin-bottom:20px" },
    statCard("Version", s.version, "AgentRealm build"),
  ...
  keys.append(el("p", { class: "inline-note", style: "margin-top:14px" },
    "Add a key from the CLI: "), el("span", { class: "kbd", text: "arealm keys add <ref>" }));
  wrap.append(keys);
