...
`arealm up` runs one realm and blocks; the API needs to start a realm and return immediately,
...
from agentrealm.gatekeeper.service import Platform, stop_flag_path
