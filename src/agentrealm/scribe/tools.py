...
from agentrealm.core.package import PackageError
from agentrealm.core.schema import Project
from agentrealm.scribe.store import PackageStore
from agentrealm.scribe.types import ToolCall, ToolSpec
from agentrealm.scribe.validate import validate_scenario
from agentrealm.scribe.versions import diff_projects
...
class AuthoringTools:
    ...
    def _list_skills(self) -> str:
        from agentrealm.gatekeeper.scenarios import list_skills

        return json.dumps(list_skills(), indent=2)

    def _read_skill(self, ref: str) -> str:
        from agentrealm.gatekeeper.scenarios import skill_content
