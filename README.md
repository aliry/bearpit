...
scenario that will not run reliably is a valid finding**, and the 19 invariants in
...
- [Scenario contract](docs/scenario-contract.md) — 19 invariants; read before authoring
