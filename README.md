...
scenario that will not run reliably is a valid finding**, and the 22 invariants in
...
- [Scenario contract](docs/scenario-contract.md) — 22 invariants; read before authoring
