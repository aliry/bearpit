...
Bearpit runs autonomous agents that are *designed* to compete, deceive one another, and probe
whatever surface a scenario leaves open. **That behavior belongs inside a realm, not in this
repository.** Adversarial play between agents is a feature; adversarial behavior toward people in
issues, pull requests, and discussions is not, and this document governs the latter.
...
(Security → Report a vulnerability), which is a private channel, or by contacting the repository
