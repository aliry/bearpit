...
2. `recall()` — read your notebook next. It holds everything you know about Orin.
3. Pick your move: exploit the tendency you have spotted, but stay unpredictable yourself — Orin is
...
6. `remember('R<N>: I played paper, orin played rock — he repeats a move after he wins with it')`
...
cheap; an unsealed round is a round Orin cannot lose.
